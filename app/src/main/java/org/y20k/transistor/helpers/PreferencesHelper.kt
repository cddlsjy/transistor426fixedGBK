...
object PreferencesHelper {
    ...
    /* Loads the user-selected charset for metadata decoding */
    fun loadMetadataCharset(): Charset {
        val charsetName = sharedPreferences.getString(Keys.PREF_METADATA_CHARSET, Keys.METADATA_CHARSET_UTF8) ?: Keys.METADATA_CHARSET_UTF8
        return when (charsetName) {
            Keys.METADATA_CHARSET_GBK -> Charset.forName("GBK")
            else -> Charsets.UTF_8
        }
    }
