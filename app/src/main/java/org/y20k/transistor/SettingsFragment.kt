...
class SettingsFragment: PreferenceFragmentCompat(), YesNoDialog.YesNoDialogListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        preferenceAutoPlayLastStation.setIcon(R.drawable.ic_play_arrow_24dp)
        preferenceAutoPlayLastStation.key = Keys.PREF_AUTO_PLAY_LAST_STATION
        preferenceAutoPlayLastStation.summaryOn = getString(R.string.pref_auto_play_last_station_summary_enabled)
        preferenceAutoPlayLastStation.summaryOff = getString(R.string.pref_auto_play_last_station_summary_disabled)
        preferenceAutoPlayLastStation.setDefaultValue(PreferencesHelper.loadAutoPlayLastStation())


        // set up "Remote Control" preference
        val preferenceRemoteControl: SwitchPreferenceCompat = SwitchPreferenceCompat(activity as Context)
        preferenceRemoteControl.title = getString(R.string.pref_remote_control_title)
        preferenceRemoteControl.setIcon(R.drawable.ic_remote_24dp)
        preferenceRemoteControl.key = Keys.PREF_REMOTE_CONTROL_ENABLED
        preferenceRemoteControl.summaryOn = getString(R.string.pref_remote_control_summary_enabled)
        preferenceRemoteControl.summaryOff = getString(R.string.pref_remote_control_summary_disabled)
...
//        }
        ...
        // set up "Metadata Charset" preference
        val preferenceMetadataCharset: ListPreference = ListPreference(activity as Context)
        preferenceMetadataCharset.title = getString(R.string.pref_metadata_charset_title)
        preferenceMetadataCharset.setIcon(R.drawable.ic_music_note_24dp)
        preferenceMetadataCharset.key = Keys.PREF_METADATA_CHARSET
        preferenceMetadataCharset.summary = getString(R.string.pref_metadata_charset_summary)
        preferenceMetadataCharset.entries = arrayOf("UTF-8", "GBK")
        preferenceMetadataCharset.entryValues = arrayOf(Keys.METADATA_CHARSET_UTF8, Keys.METADATA_CHARSET_GBK)
        preferenceMetadataCharset.setDefaultValue(Keys.METADATA_CHARSET_UTF8)
        preferenceMetadataCharset.setOnPreferenceChangeListener { _, newValue ->
            if (preferenceMetadataCharset.entryValues.indexOf(newValue) != -1) {
        ...
        preferenceCategoryGeneral.contains(preferenceRemoteControl)
...
//        preferenceCategoryMaintenance.contains(preferenceUpdateCollection)
        ...
        preferenceCategoryAdvanced.contains(preferenceMetadataCharset)
...
//        screen.addPreference(preferenceUpdateCollection)
        ...
        screen.addPreference(preferenceMetadataCharset)
